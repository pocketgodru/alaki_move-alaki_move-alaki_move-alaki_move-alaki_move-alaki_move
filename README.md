...
5. [Создание сайта и пользовательский путь](#создание-сайта-и-пользовательский-путь)  (СКРИНЫ)
   - [Опрос](#опрос)
...
**Результаты сбора данных:** **(ПРАВКИ?)**
...
### Машинное обучение
- **SentenceTransformer** (paraphrase-multilingual-mpnet-base-v2) - модель для создания векторных представлений текста
