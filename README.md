...
3. ⚙[Используемый стек технологий](#-используемый-стек-технологий)
   - 🖥️[Языки программирования и фреймворки](#%EF%B8%8Fязыки-программирования-и-фреймворки)
   - 🗄️[Базы данных](#%EF%B8%8Fбазы-данных)
   - 🤖[Поиск](#поиск)
...
6. 🌐[Создание сайта и пользовательский путь](#-создание-сайта-и-пользовательский-путь)  
   - [Опрос](#опрос)
7. [Микросервисная архитектура поиска фильмов](#микросервисная-архитектура-поиска-фильмов)
...
### 🖥️Языки программирования и фреймворки
- **Python 3.10**
